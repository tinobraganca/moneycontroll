...
@Entity
@Table(name="user" , schema = "moneycontroll")
...
//    @NotNull
//    @NotEmpty
//    @Size(min=4, max=32, message="Login is too short ou too long")
//    @Column(name="provaderId", nullable=false, unique=true, length=64)
//    private String provaderId;
...
//	public String getProvaderId() {
//		return provaderId;
//	}
//
//	public void setProvaderId(String provaderId) {
//		this.provaderId = provaderId;
//	}
